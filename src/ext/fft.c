...
double uli_api_fft(uli_mem* memory, s32 startFreq, s32 endFreq)
{
#ifdef ULI78_FFT_UNSUPPORTED
    return 0.0;
#else
...
double uli_api_ffts(uli_mem* memory, s32 startFreq, s32 endFreq)
{
#ifdef ULI78_FFT_UNSUPPORTED
    return 0.0;
#else
