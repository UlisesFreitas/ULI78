...
struct retro_core_option_definition option_defs_us[] = {
   {
      "uli78_crop_border",
      "Crop Border",
      "Remove the characteristic ULI-78 screen border (typically used only for 'ambient lighting' effects).",
      {
         { "disabled", NULL },
         { "enabled",  NULL },
         { NULL, NULL },
