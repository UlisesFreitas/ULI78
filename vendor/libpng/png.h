...
#define PNG_FILTER_HEURISULI_DEFAULT    0  /* Currently "UNWEIGHTED" */
#define PNG_FILTER_HEURISULI_UNWEIGHTED 1  /* Used by libpng < 0.95 */
#define PNG_FILTER_HEURISULI_WEIGHTED   2  /* Experimental feature */
#define PNG_FILTER_HEURISULI_LAST       3  /* Not a valid value */
...
#if defined(PNG_FLOATING_ARITHMEULI_SUPPORTED) || \
