...
1. Clone a copy of Fennel into the same directory you cloned `ULI-78` into, making them "siblings".

``` sh
git clone https://git.sr.ht/~technomancy/fennel
```

`ls` here should list both `fennel` and `ULI-78`.
...
3. From within `ULI-78/vendor/fennel/`, delete the previous files and regenerate them.
