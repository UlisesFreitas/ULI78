...
# define MRB_HAVE_TYPE_GENERIC_CHECKED_ARITHMEULI_BUILTINS
#endif
...
*/
#ifdef MRB_HAVE_TYPE_GENERIC_CHECKED_ARITHMEULI_BUILTINS
#if defined(__clang__) && (__clang_major__ == 3) && (__clang_minor__ >= 8) && \
    defined(MRB_32BIT) && defined(MRB_INT64)
#undef MRB_HAVE_TYPE_GENERIC_CHECKED_ARITHMEULI_BUILTINS
#endif
#endif
