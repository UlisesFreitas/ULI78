...
The following explains how to build ULI-78 for the Raspberry PI boards in baremetal mode, that is, without an operating system (the board boots directly in ULI-78)
...
Get a fresh copy of ULI-78 repository:
...
Build `uli78studio` for arm with baremetal customizations:
...
You can create a `uli78` folder into your SD card to put your carts in.

# Thanks

This project is built on two awesome projects, [circle](https://github.com/rsta2/circle) and [circle-stdlib](https://github.com/smuehlst/circle-stdlib). Without them, this version of ULI-78 would not exist.
