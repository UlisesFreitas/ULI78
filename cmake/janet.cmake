...
if(BUILD_WITH_JANET AND PREFER_SYSTEM_LIBRARIES)
    ...
    if(janet_INCLUDE_DIR AND janet_LIBRARY)
        ...
        target_compile_definitions(janet INTERFACE ULI_BUILD_WITH_JANET)
...
if(BUILD_WITH_JANET)
    ...
    add_library(janet ${ULI_RUNTIME} ${JANET_SRC})

    if(NOT BUILD_STATIC)
        set_target_properties(janet PROPERTIES PREFIX "")
    else()
        target_compile_definitions(janet INTERFACE ULI_BUILD_WITH_JANET=1)
    endif()
