...
if(BUILD_WITH_WASM AND PREFER_SYSTEM_LIBRARIES)
    ...
    if(wasm_INCLUDE_DIR AND wasm_LIBRARY)
        ...
        target_compile_definitions(wasm INTERFACE ULI_BUILD_WITH_WASM)
...
if(BUILD_WITH_WASM)
    ...
    add_library(wasm ${ULI_RUNTIME} ${WASM_SRC})

    if(NOT BUILD_STATIC)
        set_target_properties(wasm PROPERTIES PREFIX "")
    else()
        target_compile_definitions(wasm INTERFACE ULI_BUILD_WITH_WASM=1)
    endif()
