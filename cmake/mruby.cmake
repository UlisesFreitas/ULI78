...
if(BUILD_WITH_RUBY AND PREFER_SYSTEM_LIBRARIES)
    ...
    if(mruby_INCLUDE_DIR AND mruby_LIBRARY)
        ...
        target_compile_definitions(ruby INTERFACE ULI_BUILD_WITH_RUBY)
...
if(BUILD_WITH_RUBY)
    ...
    add_library(ruby ${ULI_RUNTIME} ${RUBY_SRC})

    if(NOT BUILD_STATIC)
        set_target_properties(ruby PROPERTIES PREFIX "")
    else()
        target_compile_definitions(ruby INTERFACE ULI_BUILD_WITH_RUBY=1)
    endif()
    ...
    if(ANDROID)
        set(MRUBY_CONFIG ${MRUBY_BUILDDIR}/uli_android.rb)
    else()
        set(MRUBY_CONFIG ${MRUBY_BUILDDIR}/uli_default.rb)
    endif()
