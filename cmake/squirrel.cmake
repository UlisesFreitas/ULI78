...
if(BUILD_WITH_SQUIRREL AND PREFER_SYSTEM_LIBRARIES)
    ...
    if(squirrel_INLCUDE_DIR AND squirrel_LIBRARY AND sqstdlib_LIBRARY)
        ...
        target_compile_definitions(squirrel INTERFACE ULI_BUILD_WITH_SQUIRREL)
...
if(BUILD_WITH_SQUIRREL)
    ...
    add_library(squirrel ${ULI_RUNTIME} ${SQUIRREL_SRC})

    if(NOT BUILD_STATIC)
        set_target_properties(squirrel PROPERTIES PREFIX "")
    else()
        target_compile_definitions(squirrel INTERFACE ULI_BUILD_WITH_SQUIRREL=1)
    endif()
