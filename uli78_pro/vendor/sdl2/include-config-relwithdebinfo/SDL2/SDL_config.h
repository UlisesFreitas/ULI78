...
/* #undef SDL_HAPULI_DUMMY */
/* #undef SDL_HAPULI_LINUX */
/* #undef SDL_HAPULI_IOKIT */
#define SDL_HAPULI_DINPUT 1
#define SDL_HAPULI_XINPUT 1
/* #undef SDL_HAPULI_ANDROID */
